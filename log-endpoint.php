...
// Permitir GET apenas para verificação (debug)
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    echo json_encode(['status' => 'ok', 'endpoint' => 'log-endpoint']);
    exit(0);
}

if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    http_response_code(405);
    echo json_encode(['error' => 'Método não permitido', 'received' => $_SERVER['REQUEST_METHOD']]);
    exit;
}
